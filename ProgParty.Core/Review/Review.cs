    ...
    public class Review
    {
        ...
        public void SetReviewPopup()
        {
            ...
            if (reviewValue % 4 == 3)
            {
                ...
                MessageDialog reviewPopup = new MessageDialog($"Do you think this {name} app is worth 5 stars? Please press 'yes' and leave a review in the store. This helps other people to find the {name} app easier. The more and better the reviews are, the easier it is to find.", $"Rate & Review {name}");
                //MessageDialog reviewPopup = new MessageDialog($"Vind je de {name} app een 5 sterren review waard, druk dan op 'Ja' en laat een review achter in de store. Dit helpt anderen om de {name} app makkelijker te vinden, want hoe beter de reviews hoe gemakkelijker de app te vinden is in de store.", $"Rate & Review {name}");
